...
class DataRecordForm(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        environmentinfo = tk.LabelFrame(self, text="Environmental Data")
        ...
        self.inputs["Equipment Failure"] = LabelInput(
            environmentinfo,
            "Equipment Failure",
            input_class=ttk.Checkbutton,
            input_var=tk.BooleanVar(),
        )
        self.inputs["Equipment Failure"].grid(row=1, column=0, sticky=tk.W)
...
class Application(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.title("DPU Data Entry Application")
        self.resizable(width=False, height=False)
        ttk.Label(
            self, text="DPU Data Entry Application", font=("TkDefaultFont", 16)
        ).grid(row=0)
